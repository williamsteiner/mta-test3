		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "weblog",
									"targetURL": "#comowiwebminweblog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comowiwebminweblog-display": {
								"semanticObject": "comowiwebminweblog",
								"action": "display",
								"description": "weblog",
								"title": "weblog",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.owi.webmin.weblog",
									"url": sap.ui.require.toUrl("com/owi/webmin/weblog")
								}
							}
						}
					}
