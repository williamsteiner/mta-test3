...
sap.ui.require([
	...
	"com/owi/webmin/weblog/test/integration/pages/Create",
	...
	sap.ui.require([
		"com/owi/webmin/weblog/test/integration/MasterJourney",
		"com/owi/webmin/weblog/test/integration/NavigationJourney",
		"com/owi/webmin/weblog/test/integration/NotFoundJourney",
		"com/owi/webmin/weblog/test/integration/BusyJourney",
		"com/owi/webmin/weblog/test/integration/FLPIntegrationJourney"
	], function () {
		QUnit.start();
	});
});