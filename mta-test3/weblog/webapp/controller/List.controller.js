sap.ui.define([
    ...
    return BaseController.extend("com.owi.webmin.weblog.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                KEYID: function(oContext) {
                    var iNumber = oContext.getProperty('KEYID'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("MSGID", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.owi.webmin.weblog.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("ROWID")
            }, bReplace);
        },
