		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "webrule 3",
									"targetURL": "#comowiwebminwebrule3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comowiwebminwebrule3-display": {
								"semanticObject": "comowiwebminwebrule3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.owi.webmin.webrule3",
									"url": sap.ui.require.toUrl("com/owi/webmin/webrule3")
								}
							}
						}
					}
