sap.ui.define([
	...
	return BaseController.extend("com.owi.webmin.weblog_crud_template.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("weblog", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("weblog", oData);
