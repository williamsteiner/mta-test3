		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "weblog_crud_template",
									"targetURL": "#comowiwebminweblogcrudtemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comowiwebminweblogcrudtemplate-display": {
								"semanticObject": "comowiwebminweblogcrudtemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.owi.webmin.weblogcrudtemplate",
									"url": sap.ui.require.toUrl("com/owi/webmin/weblogcrudtemplate")
								}
							}
						}
					}
