sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/owi/webmin/weblog_crud_template/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#crudtemplateexample-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#crudtemplateexample-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.owi.webmin.weblog_crud_template.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/owi/webmin/weblog_crud_template/localService/mockserver"], function (mockserver) {
