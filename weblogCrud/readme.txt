...
----- to import into another package            
download just the app direcory (parent of webapp and child of mta app) as a tar 
in command line go to directory of prjoect you want to add this app to 
click Welcome page and import from file 
