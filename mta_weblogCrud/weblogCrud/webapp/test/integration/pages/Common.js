sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/owi/webmin/weblogCrud/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#WebLogMaint-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#WebLogMaint-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.owi.webmin.weblogCrud.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/owi/webmin/weblogCrud/localService/mockserver"], function (mockserver) {
