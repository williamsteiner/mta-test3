sap.ui.define([
	...
	opaTest("MasterList Filtering on KEYID less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("KEYID").
		and.iSelectListItemInViewSettingsDialog("<100 MSGID").
	...
	opaTest("MasterList Filtering on KEYID more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 MSGID").
		and.iPressOKInViewSelectionDialog();
