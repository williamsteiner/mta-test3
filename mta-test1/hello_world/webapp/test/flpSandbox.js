		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "hello world",
									"targetURL": "#comowiwebminhelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comowiwebminhelloworld-display": {
								"semanticObject": "comowiwebminhelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.owi.webmin.helloworld",
									"url": sap.ui.require.toUrl("com/owi/webmin/helloworld")
								}
							}
						}
					}
